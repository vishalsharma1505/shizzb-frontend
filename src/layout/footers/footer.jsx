                ...
                <div className="tp-footer-widget footer-col-1 mb-50">
                  <div className="tp-footer-widget-content">
                    ...
                    <p className="tp-footer-desc">
                      Discover premium cosmetics and beauty essentials
                      designed to enhance your confidence and everyday
                      beauty routine.
                    </p>
                        ...
                        <div className="tp-footer-contact-content">
                          <p>
                            <a href={`mailto:${settings.email}`}>
                              {settings.email || "support@shizzb.in"}
                            </a>
                          </p>
                        </div>
                      ...
                      <div className="tp-footer-contact-item d-flex align-items-start">
                        ...
                        <div className="tp-footer-contact-content">
                          <p>
                            ...
                            >
                              {settings.address ||
                                "5B/18, NIT-5, Near Banke Bihari Mandir, Faridabad, India - 121001"}
                            </a>
                          </p>
                        </div>
